        ...
        <div>
            ...
            <div>
                <div className="flex justify-center items-start content-center flex-wrap flex-col">
                    ...
                    <div>
                        <input type="text" onChange={(event) => setMsg(event.target.value)} placeholder="Ex.: Vacina da dengue do butantan" className="rounded-[20px] w-[800px] mt-[10px] p-[15px] border-0 shadow-[0_8px_30px_rgb(0,0,0,0.12)]"/>
